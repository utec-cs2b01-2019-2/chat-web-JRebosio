...
function get_current(){
    console.log("Voy a traer al usuario impuesto");
...
function getMessages(user_from_id,user_to_id) {
    alert("Voy a traer todos los mensajes entre"+ user_from_id + "y" + user_to_id);
}

function get_all_users(user_from_id){
    console.log("Trae usuarios todos los usuarios");
